...
TkrLinkAndTreePR::TkrLinkAndTreePR(ITkrGeometrySvc* pTkrGeo, TkrClusters* pTkrClus)
{
	ini();
...
TkrLinkAndTreePR::~TkrLinkAndTreePR()
{
	clear();
...
void TkrLinkAndTreePR::setLinkList(TkrClusterLinkList* pLinks, TkrPlaneType plane)
{
	if (plane == X)
	{
		pLinkListX = pLinks;
...
TkrClusterLinkList* TkrLinkAndTreePR::getLinkList(TkrPlaneType plane)
{
	return plane == X ? pLinkListX : pLinkListY;
}

int TkrLinkAndTreePR::getNumLinks(TkrPlaneType plane)
{
	return plane == X ? numLinksX : numLinksY;
}

void TkrLinkAndTreePR::setForest(TkrLinkForest* pForest, TkrPlaneType plane)
{
	if (plane == X)
	{
		pForestX   = pForest;
...
TkrLinkForest* TkrLinkAndTreePR::getForest(TkrPlaneType plane)
{
	return plane == X ? pForestX : pForestY;
}

void TkrLinkAndTreePR::buildCand3D()
{
...
int TkrLinkAndTreePR::getNumTrees(TkrPlaneType plane)
{
	return plane == X ? numTracksX : numTracksY;
}

void TkrLinkAndTreePR::ini()
{
	numClusters = 0;
	pLinkListX  = 0;
	numLinksX   = 0;
...
/*
//########################################################
void TkrLinkAndTreePR::writeOut() const
//########################################################
{
...
/*
//########################################################
void TkrLinkAndTreePR::update(GraphicsRep& v)
//########################################################
{
